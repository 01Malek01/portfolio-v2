    ...
    <section className="hero-wrapper relative h-[70vh] flex items-center justify-center">
      ...
      className="hero-container  glass  h-[80vh] relative flex flex-col items-center justify-center gap-1">
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="intro">
          <p className="text-[12px] text-center md:text-[16px] text-slate-100 mt-4 w-[50%] mx-auto   ">
        ...
        <div className="hero-btns-container mt-1 flex justify-between md:gap-2 md:flex-row flex-col gap-1 items-center">
          ...
          >
            <a href="/Resume.pdf" download="/Resume.pdf">
              <button className="c-button">Download Resume</button>
            </a>
          </motion.div>
          <motion.div
          ...
          >
            <a href="#projects" >
              <button className="c-button">Go to Projects</button>
            </a>
          </motion.div>
          <motion.div
            initial={{ opacity: 0, x: 100 }}
          ...
          >
            <a href="https://projects-show-ms8j.vercel.app/" target="_blank">
              <button className="c-button">Try 3D Projects Show</button>
            </a>
          </motion.div>
